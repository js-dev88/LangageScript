...
#------------------------------------------------------------ 
   ...
   print("Matrice de Surclassement (H,bi) - lambda 0.75", SurclassementHbi(lamda=lambda_2,
                      csv_name=csv_name,
                      direction=direction))

   print("Matrice de Surclassement (bi,H) - lambda 0.75", SurclassementbiH(lamda=lambda_2,
                     csv_name=csv_name,
                     direction=direction))
...
#-----------------------------------------------------------------------------   
   ...
   print("Evaluation Pessimiste - lambda 0.75 ",EvalOptimisteResult_lambda_2 )
