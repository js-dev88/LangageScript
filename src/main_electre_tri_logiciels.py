...
#------------------------------------------------------------
   ...
   csv_export='./results/Logiciels_Analyse_Classement.xlsx'
   ...
   EvalOptimisteResult_lambda_1 = EvaluationPessimiste(lamda=lambda_1,
                     csv_name=csv_name,
                     direction=direction)
   
   print("Evaluation Pessimiste - lambda 0.55", EvalOptimisteResult_lambda_1)
   
   
   EvalPessimisteResult_lambda_1 = EvaluationOptimiste(lamda=lambda_1,
                     csv_name=csv_name,
                     direction=direction)
   ...
   EvalOptimisteResult_lambda_2 = EvaluationPessimiste(lamda=lambda_2,
                     csv_name=csv_name,
                     direction=direction)
   
   print("Evaluation Pessimiste - lambda 0.55", EvalOptimisteResult_lambda_2)
   
   
   EvalPessimisteResult_lambda_2 = EvaluationOptimiste(lamda=lambda_2,
                     csv_name=csv_name,
                     direction=direction)
   
   print("Evaluation Pessimiste - lambda 0.55 ",EvalPessimisteResult_lambda_2 )
   ...
   print("Taux mauvaise classification Opt - lambda 0.55", taux_mauvaise_classification_opt_lambda_2)
   ...
   print("Taux mauvaise classification Pess - lambda 0.55", taux_mauvaise_classification1_pess_lambda_2)
